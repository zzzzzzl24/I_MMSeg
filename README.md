...
## 📘 Abstract Illustration (Figure)
Click below to view the full-resolution abstract figure from the paper:

👉 **[View Figure (PDF)](./figure2.pdf)** :contentReference[oaicite:0]{index=0}
...
- **LGE (Late Gadolinium Enhancement)** — visualizes myocardial infarction and fibrosis;  
- **T2-weighted** — highlights acute injury and edema regions;  
- **bSSFP** — captures cardiac motion and provides clear anatomical boundaries.
